...
namespace TourismWebsite.ViewModels
{
    public class CreateTourViewModel
    {
        ...
        // Destinasyonları dropdownlist için doldurmak amacıyla kullanılabilir.
        // Genellikle bu tür listeler ViewBag veya ViewData ile controller'dan taşınır
        // ya da ViewModel içinde bir IEnumerable<SelectListItem> olarak tanımlanır.
        // Şimdilik sadece DestinationId'yi tutuyoruz, listeyi controller'da hazırlayacağız.
    }
} 